...
public class TaskAdapter extends ArrayAdapter<Task>{
	...
	//get the context, the resource the item will be inflated with, and the list of objects
	...
	//get id of an item, in this case is not needed, and just return same position
	@Override
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//just draw the view ONlY if it is not recycled (which means the view is null)
		//when the iteam was already drawn the adapter recycles its inflated layout for a better memory management and just needs to re-set the view children contents
		if(view == null){
