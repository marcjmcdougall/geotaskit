...
public class GingerbreadLastLocationFinder implements ILastLocationFinder {
  ...
  protected static String SINGLE_LOCATION_UPDATE_ACTION = "com.cis6930.geotaskit.SINGLE_LOCATION_UPDATE_ACTION";
    
  protected PendingIntent singleUpatePI, continuousUpdatePI;
  ...
  public GingerbreadLastLocationFinder(Context context) {
    ...
    continuousUpdatePI = PendingIntent.getBroadcast(context, 0, updateIntent, PendingIntent.FLAG_UPDATE_CURRENT);
  }

  public void forceLocRefreshOnce(){
