...
public class DatabaseInterface {
  ...
  /**
   * Convenience method that simply returns all of the tasks currently in
  ...
  /**
   * Convenience method that extracts an arrayList of tasks that contain the
   * specific keyword in their description.
   * 
   * @param keyword
   *          The word to search for.
   * @return An ArrayList containing all of the information (every column is
   *         selected by default).
   */
   ...
   * 
   * Note that this method assumes that you want ALL of the columns to be
   * returned. If the cursor does not provide this data, then an Exception will
   * be thrown.
   * 
   * @param returnData
  ...
  public int removeTask(Task task) {
    ...
    String whereClause = OpenHelper.KEY_PRIORITY + " = \'" + task.color_priority + "\'" + " AND " + OpenHelper.KEY_DESCRIPTION_SHORT + " = \'" + task.name + "\'" + " AND "
        + OpenHelper.KEY_DESCRIPTION + " = \'" + task.description + "\'" + " AND " + OpenHelper.KEY_DISTANCE + " = \'" + task.miles_left + "\'";
