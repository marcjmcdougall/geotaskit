...
public class OpenHelper extends SQLiteOpenHelper {
  ...
  private static final String DICTIONARY_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
      + DICTIONARY_TABLE_NAME + " (" + KEY_PRIORITY + " INT13, " + KEY_DESCRIPTION_SHORT
      + " TEXT, " + KEY_DESCRIPTION + " TEXT, " + KEY_DISTANCE + " TEXT, " + KEY_LATTITUDE
      + " FLOAT, " + KEY_LONGITUDE + " FLOAT);";
  private static final String DICTIONARY_TABLE_DROP = "DROP TABLE IF EXISTS "
   ...
   * 
   * @param context
   *          The context of the current Activity/Fragment.
   * @param name
   *          The name of the database.
   * @param factory
  ...
  public void onCreate(SQLiteDatabase db) {
    ...
    // Execute the SQL command to create the table (if it does not already
    // exist)
