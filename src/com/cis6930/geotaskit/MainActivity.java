...
public class MainActivity extends SherlockFragmentActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ArrayAdapter<CharSequence> list = ArrayAdapter.createFromResource(context,
        R.array.actionbar_navigation_list, R.layout.sherlock_spinner_item);
  ...
  public boolean onMenuItemSelected(int featureId, MenuItem item) {
    ...
    case R.id.action_add: {
       ...
       * f = new MyMapFragment();
       * 
       * // FragmentTransaction is obtained in order to change the fragment in the // container (R.id.content at activity_main.xml) with the requested // fragment FragmentTransaction ft =
       * getSupportFragmentManager().beginTransaction();
       * 
       * // make the change, setting the new fragment ft.replace(R.id.main_content, f);
       * 
