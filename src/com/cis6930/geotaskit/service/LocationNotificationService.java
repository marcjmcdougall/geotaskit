...
public class LocationNotificationService extends Service {
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    if (!gpsEnabled) {
      ...
      int minutes = Integer.parseInt(prefs.getString(getString(R.string.pref_user_frequency_key),
          getString(R.string.pref_user_frequency_default)));
      locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, minutes * 60 * 1000,
          METERS, loc_listener);
    }
